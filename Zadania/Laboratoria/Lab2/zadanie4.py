...
while True:
    ...
    if opcja_string == "1":
        print("\n\t\t{0} + {1} = {2}".format(str(a), str(b), str(dodawanie(a, b))))
    elif opcja_string == "2":
        print("\n\t\t{0} - {1} = {2}".format(str(a), str(b), str(odejmowanie(a, b))))
    elif opcja_string == "3":
        print("\n\t\t{0} * {1} = {2}".format(str(a), str(b), str(mnozenie(a, b))))
    elif opcja_string == "4":
        print("\n\t\t{0} / {1} = {2}".format(str(a), str(b), str(dzielenie(a, b))))
    elif opcja_string == "5":
        print("\n\t\tPole koła o promieniu {0} wynosi {1}".format(str(a), str(round(pole_kola(a), 2))))
    elif opcja_string == "6":
        print("\n\t\tObwód koła o promieniu {0} wynosi {1}".format(str(a), str(round(obwod_kola(a), 2))))
    elif opcja_string == "7":
        print("\nKoniec programu!")
        break
    else:
